...
class DestinationRepositorySample {
    ...
    init () {
        let d1 = Destination(id: UUID(), destinationName: "Stadion Utama Gelora Bung Karno", destinationExit: "Exit B", photoPath: "ImageGBK")
        let d2 = Destination(id: UUID(), destinationName: "FX Sudirman", destinationExit: "Exit A", photoPath: "ImageFXSudirman")
//        let d3 = Destination(id: UUID(), destinationName: "SCBD", destinationExit: "Exit D", photoPath: "ImageSCBD")
        let d4 = Destination(id: UUID(), destinationName: "Pacific Place", destinationExit: "Exit D", photoPath: "ImagePacificPlace")
